...
public class ClientGuiModel {
    ...
    //В нем будет храниться список всех участников чата. Сразу инициализирую его.
    private final Set<String> allUserNames = new HashSet<>();

    //3) Добавил поле String newMessage, в котором будет храниться новое сообщение, которое получил клиент.
    private String newMessage;

    //4) Добавил геттер для allUserNames, запретив модифицировать возвращенное множество - просто для показа в окне справа..
